...
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████ @rosnw2      |') end
...
message = message ..i.. '-l ['..info.username..'](t.me/rosnw2) \n'
end
...
.."\n- الانجليزيه » "..(redis:get(boss..'lock_lang'..msg.chat_id_) or 'false')
